...
# 684 "../../../server-code/src/char/char.c"
 StrBuf->Destroy(&buf);
...
# 1310 "../../../server-code/src/char/char.c"
...
# 1541 "../../../server-code/src/char/char.c"
 ...
 if( sd->found_char[slot] != -1 )
  return -2;
# 1583 "../../../server-code/src/char/char.c"
 if( (-1) == SQL->Query(inter->sql_handle, "INSERT INTO `%s` (`account_id`, `char_num`, `name`, `zeny`, `str`, `agi`, `vit`, `int`, `dex`, `luk`, `max_hp`, `hp`,"
          "`max_sp`, `sp`, `hair`, `hair_color`, `last_map`, `last_x`, `last_y`, `save_map`, `save_x`, `save_y`) VALUES ("
          "'%d', '%d', '%s', '%d',  '%d', '%d', '%d', '%d', '%d', '%d', '%d', '%d','%d', '%d','%d', '%d', '%s', '%d', '%d', '%s', '%d', '%d')",
          char_db, sd->account_id , slot, esc_name, start_zeny, str, agi, vit, int_, dex, luk,
          (40 * (100 + vit)/100) , (40 * (100 + vit)/100 ), (11 * (100 + int_)/100), (11 * (100 + int_)/100), hair_style, hair_color,
          mapindex->id2name((start_point.map),"../../../server-code/src/char/char.c", 1588, __func__), start_point.x, start_point.y, mapindex->id2name((start_point.map),"../../../server-code/src/char/char.c", 1588, __func__), start_point.x, start_point.y) )
 {
  (SQL->ShowDebug_((inter->sql_handle), "../../../server-code/src/char/char.c", 1590));
  return -2;
 }
...
# 1767 "../../../server-code/src/char/char.c"
...
# 1862 "../../../server-code/src/char/char.c"
 ...
 WBUFW(buf,42) = (((p->hp) < (
# 1869 "../../../server-code/src/char/char.c" 3 4
                (32767)
# 1869 "../../../server-code/src/char/char.c"
                )) ? (p->hp) : (
# 1869 "../../../server-code/src/char/char.c" 3 4
                (32767)
# 1869 "../../../server-code/src/char/char.c"
                ));
 WBUFW(buf,44) = (((p->max_hp) < (
# 1870 "../../../server-code/src/char/char.c" 3 4
                (32767)
# 1870 "../../../server-code/src/char/char.c"
                )) ? (p->max_hp) : (
# 1870 "../../../server-code/src/char/char.c" 3 4
                (32767)
# 1870 "../../../server-code/src/char/char.c"
...
# 1934 "../../../server-code/src/char/char.c"
 return 106+offset;
}
...
void char_parse_char_delete_char(int fd, struct char_session_data* sd, unsigned short cmd)
{
 ...
 int cid = RFIFOL(fd,2);
 int i;
# 4672 "../../../server-code/src/char/char.c"
 (showmsg->showInfo(("\033[1;31m""Request Char Deletion: ""\033[1;32m""%d (%d)""\033[0m""\n"), sd->account_id, cid));
...
# 5005 "../../../server-code/src/char/char.c"
   ...
   break;
# 5019 "../../../server-code/src/char/char.c"
   case 0x67:
   {
    do { if(RFIFOREST(fd) < (37)) return 0; if (sd==
# 5021 "../../../server-code/src/char/char.c" 3 4
   ((void *)0) 
# 5021 "../../../server-code/src/char/char.c"
   || !sd->auth) { RFIFOSKIP(fd,(37)); return 0; } } while (0);
